...
?>
        ...
        <div class="page-title">
          <div>
            <h1><i class="fa fa-user"></i> Editar perfil</h1>
            <!-- <p>Sample forms</p> -->
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
            ...
            <a href="listarUsuarios.php" class="voltar"><i class="fa fa-angle-double-left"></i> Voltar para todos <span class="text-lowercase">perfil</span></a><br><br>
            <div class="card">
              ...
              <div class="card-body">
                <form id="form" method="POST" action="API/usuarios.php" ng-app="myApp" ng-controller="myCtrl"> 
                  ...
                  <input type="hidden" name="perfil" value="OK" />
                  <input type="hidden" name="id" id="id" value="<?php echo $_SESSION['id']?>" />               
                  <div class="form-group">
                    <label class="control-label">Nome</label>
                    <input class="form-control" type="text" placeholder="Nome" name="nome" id="nome" value="" required ng-model="nome">                  
                  </div>

                  <div class="form-group">
                    <label class="control-label">Email</label>
                    <input class="form-control" type="text" placeholder="Email" name="email" id="email" required ng-model="email">                  
                  </div>
