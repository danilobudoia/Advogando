...
?>
        ...
        <div class="page-title">
          <div>
            <h1><i class="fa fa-users"></i> Adicionar cliente</h1>
            <!-- <p>Sample forms</p> -->
          </div>
          <div>
            <ul class="breadcrumb">
        ...
        <div class="row">
          ...
          <a href="listarClientes.php" class="voltar"><i class="fa fa-angle-double-left"></i> Voltar para todos <span class="text-lowercase">clientes</span></a><br><br>
            ...
            <div class="card">
              ...
              <div class="card-body">
                <form id="form" method="POST" action="API/clientes.php"> 
                  ...
                  <button type="button" class="btn btn-success" id="bt_novo" data-toggle="modal" data-target="#bt_modal">Adicionar Novo</button>
                  ...
                  <div class="card-footer">
                    <button class="btn btn-primary icon-btn" type="submit"><i class="fa fa-fw fa-lg fa-check-circle"></i>Cadastrar</button>&nbsp;&nbsp;&nbsp;<a class="btn btn-default icon-btn voltar" href="listarClientes.php"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
                  </div>
                </form>   
              </div>
            </div>
