<?php
  ...
  $listaRepresentantes = $representantes->selectAll();
?>
              ...
              <div class="row">
                <div class="col-md-9">
                  ...
                  <div class="card-title">
                    <a href="inserirRepresentante.php" class="btn btn-primary ladda-button" data-style="zoom-in"><span class="ladda-label"><i class="fa fa-plus"></i> Novo representante</span></a>
                  </div>
                  -->
                </div>
                <div class="col-md-3">
                  <div class="card-title">
                      <a href="listarRepresentantesArquivados.php" class="btn btn-danger delete" data-style="zoom-in"><span class="ladda-label"> <i class="fa fa-archive" aria-hidden="true"></i> Represen. arquivados</span></a>
                    </div>
                </div>
              </div>
    ...
    <script type="text/javascript">
      $(document).ready(function() {                    
        ...
        table.on('click', '.edit', function(event) {
          ...
          window.location.href = 'editarRepresentante.php?id='+id;
        });
        ...
        table.on('click', '.delete', function(event) {
          ...
          swal({
            ...
            confirmButtonText: "Sim, arquivar representante!",
            ...
            if (isConfirm) {
              ...
              swal("Cancelado", "Representante ainda ativado:)", "error");
            }
          });                          
        });
      });
